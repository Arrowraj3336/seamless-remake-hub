      ...
      <div className="container mx-auto text-center max-w-5xl relative z-10">
        ...
        >
          ...
          <span className="text-xs sm:text-sm font-medium text-muted-foreground">
            🎬 Introducing <span className="text-primary font-semibold"> Flow Pro</span> — Now Available
          </span>
        </div>
        ...
        <div
          ref={modelsRef}
          className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mt-3 mb-5 sm:mb-6 opacity-0 px-2"
        >
        ...
        <div
          ref={ctaRef}
          className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-3 opacity-0 px-4"
        >
          <Button
            size="lg"
