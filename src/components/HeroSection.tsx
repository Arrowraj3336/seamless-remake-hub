  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto text-center max-w-5xl relative z-10">
        ...
        {/* AI Models badges */}
        <div ref={modelsRef} className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-8 sm:mb-10 opacity-0 px-2">
        ...
        {/* CTA Buttons */}
        <div ref={ctaRef} className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-8 opacity-0 px-4">
          <Button
            size="lg"
