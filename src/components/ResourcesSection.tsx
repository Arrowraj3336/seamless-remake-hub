...
const ResourcesSection = () => {
  ...
  return (
    <section ref={sectionRef} id="resources" className="py-20 md:py-32">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          {/* Left content */}
          <div className="resource-item opacity-0">
            ...
            <a
              href="#"
              className="inline-flex items-center text-primary hover:underline underline-offset-4 font-medium"
            >
              View all resources
          ...
          <div className="space-y-6">
            {resources.map((resource, index) => (
              <div
                key={index}
                className="resource-item opacity-0 group flex gap-4 md:gap-6 p-4 rounded-xl bg-card gradient-border card-hover cursor-pointer"
              >
